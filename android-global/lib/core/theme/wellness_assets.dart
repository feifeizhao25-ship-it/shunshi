...
//
// Wellness内容分类图片映射 — 根据内容 type 自动匹配本地 asset 图片

import 'dart:math';
import '../../data/acupoint_images.dart';

/// 根据内容 type Back一个随机本地 asset 图片路径
/// 用于没有 image_url 或图片Load failed时的 fallback
class WellnessAssets {
  ...
  /// 根据Acupressure名称查找已有Acupressure图
