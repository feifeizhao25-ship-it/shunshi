...
/// "Breathing into Change" — 10 Min Grounding meditation player
///
/// Structure:
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // ── Title ──
            Text(AppLocalizations.of(context).get('meditation_breathing'), style: TextStyle(
              fontSize: 24, fontWeight: FontWeight.w700,
              color: ShunShiColors.textPrimary, fontFamily: ShunShiTypography.serifFamily,
            )),
            const SizedBox(height: 4),
            Text(AppLocalizations.of(context).get('meditation_10min_grounding'), style: TextStyle(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(AppLocalizations.of(context).get('meditation_atmosphere'), style: TextStyle(
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: Text(AppLocalizations.of(context).get('meditation_checkin'), style: TextStyle(
