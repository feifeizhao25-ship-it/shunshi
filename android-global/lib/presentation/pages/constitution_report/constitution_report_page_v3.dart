  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: isDark ? ShunshiDarkColors.background : ShunShiColors.background,
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).t('constitutionrep_body_type_report'),
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (widget.scores != null && widget.scores!.isNotEmpty) ...[
                    Text(AppLocalizations.of(context).t('constitutionrep_body_type_score_distribution'), style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary)),
                    const SizedBox(height: 12),
                    ..._sortedScoreBars(),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Row(children: [
                          ...
                          Text(AppLocalizations.of(context).t('constitutionrep_ai_wellness_summary'),
                  ...
                  // 引用
                  Center(child: Text(AppLocalizations.of(context).t('constitutionrep_rest_the_body_move_to_nourish_qi'),
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text(AppLocalizations.of(context).t('constitutionrep_generating_wellness_calendar')), duration: Duration(seconds: 1)),
                        );
                      },
                      icon: const Icon(Icons.calendar_month, size: 20),
                      label: Text(AppLocalizations.of(context).t('constitutionrep_generate_wellness_calendar'), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
