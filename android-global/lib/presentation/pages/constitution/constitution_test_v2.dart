...
class _ConstitutionTestV2State extends State<ConstitutionTestV2> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_loading) return Scaffold(backgroundColor: isDark ? ShunShiColors.darkBackground : ShunShiColors.background, body: Center(child: CircularProgressIndicator(color: ShunShiColors.primary)));
    if (_result != null) return _buildResult();
    if (_questions.isEmpty) return Scaffold(backgroundColor: isDark ? ShunShiColors.darkBackground : ShunShiColors.background, body: Center(child: Text(AppLocalizations.of(context).t('constitution_no_questions_available'), style: TextStyle(color: ShunShiColors.textTertiary))));
      ...
      body: SafeArea(child: Column(children: [
        ...
        Padding(padding: const EdgeInsets.fromLTRB(24, 16, 24, 0),
          child: Row(children: [
            ...
            const Spacer(),
            Text(AppLocalizations.of(context).t('constitution_constitution_analysis'), style: TextStyle(fontFamily: ShunShiTypography.serifFamily, fontSize: 14, fontWeight: FontWeight.w600, color: ShunShiColors.primary)),
            const Spacer(),
      ...
      body: SafeArea(child: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Center(child: Column(children: [
            ...
            Text(AppLocalizations.of(context).t('constitution_your_constitution_type'), style: TextStyle(fontSize: 14, color: ShunShiColors.textTertiary)),
          ...
          Container(padding: const EdgeInsets.all(20), decoration: BoxDecoration(color: ShunShiColors.surface, borderRadius: BorderRadius.circular(16)),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(AppLocalizations.of(context).t('constitution_constitution_score'), style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary)),
              const SizedBox(height: 16),
          ...
          Container(padding: const EdgeInsets.all(20), decoration: BoxDecoration(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                ...
                const SizedBox(width: 8),
                Text(AppLocalizations.of(context).t('constitution_wellness_tips'), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: Colors.white)),
              ]),
          ...
          Row(children: [
            Expanded(child: OutlinedButton(onPressed: () => setState(() {_result = null; _answers.clear(); _current = 0;}),
              ...
              child: Text(AppLocalizations.of(context).t('constitution_retake_2'), style: TextStyle(color: ShunShiColors.primary)))),
            const SizedBox(width: 12),
            Expanded(child: ElevatedButton(onPressed: () => Navigator.pop(context),
              ...
              child: Text(AppLocalizations.of(context).t('done'), style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)))),
          ]),
        ]),
      )),
    );
