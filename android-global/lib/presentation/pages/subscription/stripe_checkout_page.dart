...
class _StripeCheckoutPageState extends State<StripeCheckoutPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: isDark ? ShunshiDarkColors.background : ShunShiColors.background,
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).t('subscription_checkout'),
  ...
  Widget _buildContent() {
    ...
    return Column(
      ...
      children: [
        Text(AppLocalizations.of(context).t('subscription_complete_your_subscription'),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(AppLocalizations.of(context).t('subscription_secure_payment'),
                      style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                    const SizedBox(height: 4),
                    Text(AppLocalizations.of(context).t('subscription_powered_by_stripe'),
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: Text(AppLocalizations.of(context).t('subscription_proceed_to_payment'), style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
          ),
        ),
      ],
    );
