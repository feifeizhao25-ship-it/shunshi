...
class _FamilyInvitePageState extends State<FamilyInvitePage> {
  ...
  Future<void> _loadFamilyMembers() async {
    ...
    if (mounted) {
      setState(() {
        _familyMembers = [
          {'name': 'Me', 'relation': 'This person', 'avatar': '👤'},
        ];
      });
    }
  }
  ...
  void _copyCode() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(AppLocalizations.of(context).t('family_invite_code_copied_to_clipboard')),
  ...
  void _shareCode() {
    ...
    final text = 'I\'m using SEASONS wellness app, invite you to join! Code: ${_code ?? ''}';
    Clipboard.setData(ClipboardData(text: text));
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(AppLocalizations.of(context).t('family_invite_content_copied_paste_and_send_to_famil')),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Text(AppLocalizations.of(context).t('family_invite_code'), style: TextStyle(fontSize: 14, color: ShunShiColors.textTertiary)),
                        ...
                        const SizedBox(height: 16),
                        const Text(
                          'Share this invite code with family\nThey can enter it on the Profile > Family page to join',
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: OutlinedButton.icon(
                            ...
                            label: Text(AppLocalizations.of(context).t('family_copy_invite_code')),
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            label: Text(AppLocalizations.of(context).t('family_share_with_family')),
