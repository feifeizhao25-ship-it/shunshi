...
class _FamilyHomePageState extends State<FamilyHomePage> {
  ...
  Future<void> _loadMembers() async {
    ...
    setState(() {
      _members = [
        {'id': '1', 'name': 'Mom', 'avatar': '👩', 'relation': 'Mother', 'status': 'stable', 'lastActive': 'Today 08:30', 'lastCheckin': '3h ago'},
        {'id': '2', 'name': 'Dad', 'avatar': '👨', 'relation': 'Father', 'status': 'tired', 'lastActive': 'Today 07:15', 'lastCheckin': '5h ago'},
        {'id': '3', 'name': 'Grandma', 'avatar': '👵', 'relation': 'Other', 'status': 'attention', 'lastActive': 'Yesterday 22:00', 'lastCheckin': '1d ago'},
      ];
      _loading = false;
    });
  }
  ...
  String _statusText(String status) {
    switch (status) {
      ...
      case 'attention': return 'Suggest contact';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: isDark ? ShunshiDarkColors.background : ShunShiColors.background,
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).t('family_my_family'),
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        SizedBox(width: 8),
                        Text(AppLocalizations.of(context).t('family_invite_family'), style: TextStyle(fontSize: 15,
                  ...
                  Container(
                    ...
                    child: const Row(children: [
                      ...
                      SizedBox(width: 8),
                      Expanded(child: Text('Privacy: Only status level is shared, no detailed data exposed',
                  ...
                  if (_members.isEmpty)
                    Center(child: Padding(
                      ...
                      child: Text(AppLocalizations.of(context).t('family_no_members'), style: TextStyle(color: ShunShiColors.textTertiary, fontSize: 15)),
                    ))
                  else
