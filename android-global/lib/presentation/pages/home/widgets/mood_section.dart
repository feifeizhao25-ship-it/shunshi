...
class MoodSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final moods = [
      ('calm', '😌', 'Calm'), ('tired', '😴', 'Exhausted'), ('anxious', '😰', 'Anxious'),
      ('peaceful', '🕊️', 'Peaceful'), ('energetic', '⚡', 'Energetic'), ('overwhelmed', '🫧', 'Anxious'),
    ];
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(AppLocalizations.of(context).t('home_how_are_you_feeling_right_now'),
          style: TextStyle(
