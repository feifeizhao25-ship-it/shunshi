  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: isDark ? ShunshiDarkColors.background : ShunShiColors.background,
      appBar: AppBar(
        ...
        title: Text(_data?['title'] ?? 'Meridian Details',
      ...
      body: StateView<Map<String, dynamic>>(
        loading: _loading,
        error: !_loading && _data == null ? 'Content loading failed' : null,
        data: _data,
        onRetry: _loadData,
        ...
        builder: (data) => SingleChildScrollView(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        if (_data?['best_time'] != null)
                          Row(children: [
                            ...
                            Text('Best time: ${_data?['best_time']}', style: const TextStyle(fontSize: 13, color: Color(0xFFE4C285))),
                          ]),
                        if (_data?['duration_minutes'] != null && _data?['duration_minutes'] > 0) ...[
                          ...
                          Row(children: [
                            ...
                            const SizedBox(width: 6),
                            Text('Estimated time: ${_data?['duration_minutes']} min', style: const TextStyle(fontSize: 13, color: Color(0xFFE4C285))),
                          ]),
                        ],
                      ]),
                    ),
                    ...
                    // Description
                    Text(AppLocalizations.of(context).t('meridian_meridian_overview'), style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary)),
                    const SizedBox(height: 8),
                    Text(_data?['description'] ?? '', style: TextStyle(fontSize: 14, color: ShunShiColors.textSecondary, height: 1.8)),
                    const SizedBox(height: 20),

                    // Steps
                    Text(AppLocalizations.of(context).t('meridian_massage_steps'), style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary)),
                    const SizedBox(height: 8),
                    _buildSteps(),
                    const SizedBox(height: 20),
                    ...
                    if (_data?['source_classic'] != null) ...[
                      Container(
                        ...
                        child: Row(children: [
                          ...
                          Text('Source: ${_data!['source_classic']}',
                    ...
                    // Quote
                    Center(child: Text(AppLocalizations.of(context).t('meridian_where_there_is_flow_there_is_no_pain'),
