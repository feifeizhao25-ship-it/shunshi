              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(AppLocalizations.of(context).t('diary_good_morning_seasons_friend'), style: TextStyle(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text('$month/$day \u2022 Grain Rain', style: TextStyle(
                  ...
                  const Text('Wellness Diary · Today\'s Record', style: TextStyle(
                    fontSize: 36, fontWeight: FontWeight.w400,
                    color: ShunShiColors.primary, height: 1.2,
                    fontFamily: ShunShiTypography.serifFamily,
                  )),
                  const SizedBox(height: 4),
                  const Text('"Follow the seasons, listen to your body\'s rhythm."', style: TextStyle(
                  ...
                  // ── 睡眠质量 ──
                  _sectionHeader(Icons.bedtime, 'Sleep Quality'),
                  const SizedBox(height: 16),
                  Row(
                    children: [
                      Expanded(child: _sleepCard('Bedtime', '22:45', 'PM')),
                      const SizedBox(width: 16),
                      Expanded(child: _sleepCard('Wake time', '06:30', 'AM')),
                    ],
                  ),
                  const SizedBox(height: 40),

                  // ── 情绪图谱 ──
                  _sectionHeader(Icons.self_improvement, 'Mood Map'),
                  const SizedBox(height: 16),
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        _moodButton(0, Icons.sentiment_satisfied, 'Happy'),
                        _moodButton(1, Icons.spa, 'Calm'),
                        _moodButton(2, Icons.bed, 'Tired'),
                        _moodButton(3, Icons.cloud, 'Melancholy'),
                      ],
                    ),
                  ),
                  const SizedBox(height: 40),
                  ...
                  // ── 每日仪式 ──
                  _sectionHeader(Icons.done_all, 'Daily Rituals'),
                  const SizedBox(height: 16),
                  Row(
                    children: [
                      Expanded(child: _habitCard(0, Icons.emoji_food_beverage, 'Tea')),
                      const SizedBox(width: 12),
                      Expanded(child: _habitCard(1, Icons.air, 'Meditation')),
                      const SizedBox(width: 12),
                      Expanded(child: _habitCard(2, Icons.directions_walk, 'Exercise')),
                    ],
                  ),
                  const SizedBox(height: 40),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Row(
                  children: [
                    _pulsingIcon(),
                    const SizedBox(width: 8),
                    Text(AppLocalizations.of(context).t('diary_ai_insights'), style: TextStyle(
                ...
                Container(
                  ...
                  child: Text(AppLocalizations.of(context).t('ai_generating'), style: TextStyle(
            ...
            // Insight text
            Text(
              '"During Grain Rain, your routine suggests slight dampness. I\'m preparing a perfect afternoon tea blend to harmonize your body and mind..."',
              style: TextStyle(
