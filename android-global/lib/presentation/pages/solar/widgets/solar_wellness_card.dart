/// Solar TermWellness卡片 — 显示当前Solar Term+时Chen+Dietsuggestion: 
library;
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  '${shichen['name'] ?? ''} ${shichen['organ'] ?? ''} Meridian Active',
                  style: const TextStyle(
          ...
          Align(
            ...
            child: TextButton.icon(
              ...
              label: Text(AppLocalizations.of(context).t('solar_view_details'), style: TextStyle(color: ShunShiColors.primary, fontSize: 13)),
