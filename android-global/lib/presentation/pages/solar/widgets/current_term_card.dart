        ...
        child: Column(
          ...
          children: [
            Row(children: [
              ...
              Text('Today：${term.name}', style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w600, color: Colors.white, height: 1.3)),
            ]),
            ...
            Row(children: [
              ...
              Text('2026year${term.date} · ${term.seasonLabel} · ${term.durationDays}day',
