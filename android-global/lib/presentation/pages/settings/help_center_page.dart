...
class _HelpCenterPageState extends State<HelpCenterPage> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: AppLocalizations.of(context).t('help_center_search_for_help'),
              ...
              children: [
                Expanded(
                  child: _QuickActionCard(
                    ...
                    label: AppLocalizations.of(context).t('settings_email_us'),
                    subtitle: AppLocalizations.of(context).t('settings_response_in_24h'),
                ...
                Expanded(
                  child: _QuickActionCard(
                    icon: Icons.restore,
                    label: AppLocalizations.of(context).t('settings_restore'),
                    subtitle: AppLocalizations.of(context).t('subscription_title'),
            ...
            _buildFaqCategory(
              context,
              title: AppLocalizations.of(context).t('settings_getting_started'),
              icon: '🌿',
              items: [
                _FaqItem(
            ...
            _buildFaqCategory(
              context,
              title: AppLocalizations.of(context).t('settings_subscription_billing'),
              icon: '💳',
              items: [
                _FaqItem(
            ...
            _buildFaqCategory(
              context,
              title: AppLocalizations.of(context).t('settings_privacy_data'),
              icon: '🔒',
              items: [
                _FaqItem(
            ...
            _buildFaqCategory(
              context,
              title: AppLocalizations.of(context).t('ai_companion'),
              icon: '🤖',
              items: [
                _FaqItem(
            ...
            _buildFaqCategory(
              context,
              title: AppLocalizations.of(context).t('settings_family_accounts'),
              icon: '👨‍👩‍👧',
              items: [
                _FaqItem(
            ...
            _buildFaqCategory(
              context,
              title: AppLocalizations.of(context).t('settings_technical_issues'),
              icon: '⚙️',
              items: [
                _FaqItem(
  ...
  void _showEmailSupport(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(AppLocalizations.of(context).t('settings_email_us_at_supportseasonsapp')),
