                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: Text(AppLocalizations.of(context).t('discover_wellness_library'), style: TextStyle(
                        fontFamily: ShunShiTypography.serifFamily,
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: AppLocalizations.of(context).t('wellness_library_search_wellness_content'),
                    ...
                    child: Padding(
                      ...
                      child: _filtered.isEmpty
                          ? Center(child: Padding(
                              ...
                              child: Text(AppLocalizations.of(context).t('library_no_content_found_for_this_filter'), style: TextStyle(color: ShunShiColors.textTertiary)),
                            ))
                          : Column(
