  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text(AppLocalizations.of(context).t('profile_discover_your_body_type'), style: ShunshiTextStyles.greeting),
          const SizedBox(height: 8),
          Text('TCM Body Type identification — find the wellness path best suited for you', style: ShunshiTextStyles.bodySecondary),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(AppLocalizations.of(context).t('wellness_start_test'), style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600)),
            ),
          ),
          const SizedBox(height: 32),
          Text(AppLocalizations.of(context).t('wellness_9_body_types'), style: ShunshiTextStyles.heading),
