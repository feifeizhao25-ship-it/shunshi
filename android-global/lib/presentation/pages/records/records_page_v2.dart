  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: isDark ? ShunshiDarkColors.background : ShunShiColors.background,
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).t('records_wellnessrecords'), style: TextStyle(fontFamily: ShunShiTypography.serifFamily, fontSize: 18, fontWeight: FontWeight.w600)),
      ),
        ...
        child: ListView(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  ...
                  Text(AppLocalizations.of(context).t('records_today'), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary)),
                  const Spacer(),
            ...
            if (_sleepStats.isNotEmpty) ...[
              Text(AppLocalizations.of(context).t('records_sleep_stats'), style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary)),
              const SizedBox(height: 12),
              Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(color: ShunShiColors.surface, borderRadius: BorderRadius.circular(14)),
                child: Row(children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(AppLocalizations.of(context).t('records_avg_sleep'), style: TextStyle(fontSize: 13, color: ShunShiColors.textTertiary)),
                    Text('${_sleepStats['avg_hours'] ?? '-'}/hr', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: ShunShiColors.textPrimary)),
                  ])),
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(AppLocalizations.of(context).t('records_quality_score'), style: TextStyle(fontSize: 13, color: ShunShiColors.textTertiary)),
            ...
            if (_emotionTrends.isNotEmpty) ...[
              Text(AppLocalizations.of(context).t('records_mood_trends'), style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary)),
              const SizedBox(height: 12),
