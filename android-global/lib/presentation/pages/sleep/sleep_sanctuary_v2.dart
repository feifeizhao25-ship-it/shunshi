          ...
          children: [
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                Text(AppLocalizations.of(context).t('sleep_sleep_sanctuary'), style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white70)),
                const Spacer(),
            ...
            Text(AppLocalizations.of(context).t('sleep_nightfall_stillness'), style: TextStyle(
              fontFamily: ShunShiTypography.serifFamily,
              fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white,
            )),
            const SizedBox(height: 4),
            Text(AppLocalizations.of(context).t('sleep_30_min_deep_sleep'), style: TextStyle(fontSize: 14, color: Colors.white38)),
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(AppLocalizations.of(context).t('sleep_sleep_stories'), style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white70)),
                const SizedBox(height: 10),
                _buildStory('Rain on Leaves', '25 min'),
                _buildStory('Midnight Garden', '20 min'),
                _buildStory('Mountain Stream', '30 min'),
              ]),
            ),
