      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // ── Now Playing ──
            Text(AppLocalizations.of(context).t('sleep_currently_playing'), style: TextStyle(
              fontSize: 13, color: Colors.white54,
              fontFamily: ShunShiTypography.sansFamily, letterSpacing: 1,
            )),
            const SizedBox(height: 16),
            Text(AppLocalizations.of(context).t('sleep_midnight_rainfall'), style: const TextStyle(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(AppLocalizations.of(context).t('sleep_natures_layer'), style: TextStyle(
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(AppLocalizations.of(context).t('sleep_bedtime_tales'), style: TextStyle(
                    fontSize: 18, fontWeight: FontWeight.w700,
                    color: Colors.white, fontFamily: ShunShiTypography.serifFamily,
                  )),
                  const SizedBox(height: 4),
                  Text(AppLocalizations.of(context).t('sleep_gently_drift_into_the_world_of_dreams'), style: TextStyle(
