          ...
          child: Column(
            ...
            children: [
              ...
              Row(children: [
                ...
                const Spacer(),
                Text(AppLocalizations.of(context).get('checkin_sanctuary'), style: TextStyle(
              ...
              // Morning Stillness
              Text(AppLocalizations.of(context).get('checkin_morning'), style: TextStyle(
                fontFamily: ShunShiTypography.serifFamily,
              ...
              Container(
                ...
                child: Row(children: [
                  ...
                  const Spacer(),
                  Text(AppLocalizations.of(context).get('checkin_streak_current'), style: TextStyle(fontSize: 12, color: Colors.white70)),
                ]),
              ),
              const SizedBox(height: 24),

              // Energy Level
              Text('How is your energy flowing today?', style: TextStyle(
                fontSize: 16, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary,
              )),
              const SizedBox(height: 4),
              Text('Take a quiet moment to listen to your internal landscape.',
                style: TextStyle(fontSize: 13, color: ShunShiColors.textTertiary)),
              const SizedBox(height: 12),
              Text(AppLocalizations.of(context).get('checkin_energy_level'), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: ShunShiColors.textSecondary)),
              const SizedBox(height: 8),
              Wrap(spacing: 8, children: ['Gentle Flow', 'Stillness', 'Vibrant'].map((e) =>
                GestureDetector(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text('Complete Check-in', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white)),
                ),
              ),
              const SizedBox(height: 12),
