// Theme helper — bridges ShunShiColors to AppColors-style context-aware API
...
class AppColors {
  ...
  static Color accentGold(BuildContext c) => Theme.of(c).brightness == Brightness.dark
      ? ShunShiColors.darkSecondary : ShunShiColors.gold;
}
