...
/// API 错误类型
enum ApiErrorType { network, server, unauthorized, timeout, unknown }
...
class ApiClient {
  ...
  // 真机：优先公网直连
  static final String _realDeviceUrl = AppConfig.apiBaseUrl.replaceAll(
    '/api/v1',
    '',
  );
  ...
  static String _versionedPath(String path) {
            ...
            try {
              ...
              if (resp.data is Map && resp.data['data'] != null) {
                ...
                if (newToken != null) {
                  ...
                  if (newRefresh != null)
                    await StorageManager.user.saveRefreshToken(newRefresh);
                  // 重试原请求
  ...
  Future<Response> post(String path, {dynamic data}) async {
    return await _dio.post(_versionedPath(path), data: data);
  }

  /// PUT 请求
  Future<Response> put(String path, {dynamic data}) async {
    return await _dio.put(_versionedPath(path), data: data);
  }

  /// DELETE 请求
  Future<Response> delete(String path) async {
    return await _dio.delete(_versionedPath(path));
  }
}
