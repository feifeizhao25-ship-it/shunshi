...
class _WellnessHubPageState extends State<WellnessHubPage> {
  ...
  Widget build(BuildContext context) {
    if (_isLoading) return Scaffold(backgroundColor: AppColors.background(context), body: _buildSkeleton());
                    ...
                    children: [
                      ...
                      Expanded(child: Column(
                        ...
                        children: [
                          ...
                          Text('完成体质测试，获取AI个性化养生方案', style: TextStyle(fontSize: 12, color: AppColors.textSecondary(context))),
                        ],
                      )),
