              ...
              child: Column(
                children: [
                  ...
                  GridView.count(
                    ...
                    children: [
                      _gridIcon(Icons.health_and_safety, '体质调养', () => context.push('/wellness-category/constitution')),
                      _gridIcon(Icons.restaurant_menu, '节气食谱', () => context.push('/wellness-category/food_therapy')),
                      _gridIcon(Icons.emoji_food_beverage, '养生茶饮', () => context.push('/wellness-category/tea')),
                      _gridIcon(Icons.architecture, '经络穴位', () => context.push('/wellness-category/acupressure')),
                      _gridIcon(Icons.self_improvement, '传统功法', () => context.push('/wellness-category/exercise')),
                      _gridIcon(Icons.graphic_eq, '助眠音频', () => context.push('/wellness-category/sleep')),
                    ],
                  ),
