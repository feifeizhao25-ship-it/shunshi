...
class _SubscriptionPageV2State extends State<SubscriptionPageV2> {
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            ...
            child: Text('恢复购买', style: TextStyle(fontSize: 13, color: ShunShiColors.textSecondary)),
          ),
        ],
      ),
      body: _loading
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            ...
            const Spacer(),
            if (isActive && days > 0)
              Text('$days 天剩余', style: const TextStyle(fontSize: 12, color: Color(0xFFE4C285))),
          ]),
          const SizedBox(height: 12),
          Text(
  ...
  String _getPlanSubtitle(String planId) {
    switch (planId) {
      case 'free': return '基础功能，满足日常养生需求';
      case 'yangxin': return '无限聊天 + 今日计划';
      case 'yiyang': return '深度建议 + 周总结';
      case 'jiahe': return '家庭共享（4席位）';
      default: return '';
    }
  }
  ...
  Widget _buildPlans() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('选择您的会员方案', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary)),
        const SizedBox(height: 12),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                  ...
                  const SizedBox(width: 6),
                  Padding(padding: const EdgeInsets.only(bottom: 6), child: Text('/年', style: TextStyle(fontSize: 13, color: ShunShiColors.textTertiary))),
                  const Spacer(),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(
            plan.priceCents > 0 ? '¥${plan.priceCents ~/ 100}/${plan.periodName ?? "月"}' : '免费',
  ...
  Widget _buildPurchaseButton(SubscriptionPlan plan) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text('开通', style: const TextStyle(fontSize: 12, color: Colors.white, fontWeight: FontWeight.w600)),
      ),
    );
  }
  ...
  Widget _buildFAQ() {
    return Container(
      ...
      child: Row(children: [
        ...
        const SizedBox(width: 8),
        Expanded(child: Text('如何取消自动续费？', style: TextStyle(fontSize: 14, color: ShunShiColors.textSecondary))),
