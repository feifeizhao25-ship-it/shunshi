...
class _SolarTermPageV2State extends State<SolarTermPageV2> {
                    ...
                    child: Padding(
                      ...
                      child: Row(children: [
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: surfaceLow, borderRadius: BorderRadius.circular(12),
                            ),
                        ...
                        Text('顺时', style: TextStyle(
                          ...
                          color: isDark ? ShunShiColors.darkPrimary : ShunShiColors.primary,
                        )),
                        const Spacer(),
                      ...
                      Row(children: [
                        ...
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Text(_term['name_en']?.toString() ?? '', style: TextStyle(
                            fontSize: 14, color: isDark ? ShunShiColors.darkTextTertiary : ShunShiColors.textTertiary,
                          )),
                        ])),
                      ]),
                      const SizedBox(height: 8),
                      if (_term['date'] != null)
                        Text('${_term['date']}', style: TextStyle(fontSize: 13, color: isDark ? ShunShiColors.darkTextSecondary : ShunShiColors.textSecondary)),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          ...
                          const SizedBox(width: 12),
                          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text('下一个：${_next['name']}', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: textPrimary)),
                            Text('${_next['name_en'] ?? ''} · ${_next['countdown_days'] != null ? '${_next['countdown_days']}天后' : _next['date'] ?? ''}',
                              style: TextStyle(fontSize: 12, color: isDark ? ShunShiColors.darkTextTertiary : ShunShiColors.textTertiary)),
                          ])),
                        ]),
                      ),
                    ),
  ...
  Widget _buildWellnessCard({required String icon, required String title, required String desc, List<String> tags = const []}) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final surfaceColor = isDark ? ShunShiColors.darkSurface : ShunShiColors.surface;
    return Padding(
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            Expanded(child: Text(title, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: isDark ? ShunShiColors.darkTextPrimary : ShunShiColors.textPrimary))),
          ]),
          const SizedBox(height: 6),
          Text(desc, style: TextStyle(fontSize: 12, color: isDark ? ShunShiColors.darkTextTertiary : ShunShiColors.textTertiary, height: 1.5), maxLines: 3, overflow: TextOverflow.ellipsis),
          if (tags.isNotEmpty) ...[
            const SizedBox(height: 8),
