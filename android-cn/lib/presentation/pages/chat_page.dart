...
class _ChatPageState extends State<ChatPage> with TickerProviderStateMixin {
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      try {
        ...
        final aiText = v2Data?['data']?['text'] ?? v2Data?['reply'] ?? '抱歉，暂时无法回应。';
        final convId = v2Data?['data']?['conversation_id'] ?? v2Data?['conversation_id'];
        ...
        handleAIReply(aiText, cards: v2Cards, sources: v2Sources, convId: convId);
      } catch (_) {
  ...
  void _showQuickTopics() {
    ...
    showModalBottomSheet(context: context, backgroundColor: isDark ? ShunShiColors.darkBackground : ShunShiColors.background, isScrollControlled: true, shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20))),
  ...
  Widget _buildTopBar() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: bg, border: Border(bottom: BorderSide(color: isDark ? ShunShiColors.darkBorderGhost : ShunShiColors.borderGhost, width: 0.5))),
