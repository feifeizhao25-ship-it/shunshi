      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // ── Now Playing ──
            Text('Currently Playing', style: TextStyle(
              fontSize: 13, color: Colors.white54,
              fontFamily: ShunShiTypography.sansFamily, letterSpacing: 1,
            )),
            const SizedBox(height: 16),
            Text('Midnight Rainfall', style: const TextStyle(
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Bedtime Tales', style: TextStyle(
                    fontSize: 18, fontWeight: FontWeight.w700,
                    color: Colors.white, fontFamily: ShunShiTypography.serifFamily,
                  )),
                  const SizedBox(height: 4),
                  Text('Gently drift into the world of dreams.', style: TextStyle(
