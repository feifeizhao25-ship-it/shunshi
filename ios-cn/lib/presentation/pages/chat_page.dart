    ...
    try {
      ...
      try {
        ...
        final v2Res = await v2Dio.post(
          ...
          data: {
            'message': text,
            'context': {'solar_term': _currentSolarTerm},
            'conversation_id': _conversationId,
          },
        ); // CN uses Chinese endpoint
        ...
        handleAIReply(
          ...
          cards: v2Cards,
          sources: v2Sources,
          convId: v2Res.data?['conversation_id'],
        );
      } catch (_) {
        handleAIReply(
          _offlineReply(),
  ...
  Widget _buildTopBar() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(color: ShunShiColors.borderGhost, width: 0.5),
        ),
      ),
      child: Column(
        children: [
        ...
        children: [
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: _isRecording ? Colors.red : ShunShiColors.secondary,
              ),
              child: Icon(
