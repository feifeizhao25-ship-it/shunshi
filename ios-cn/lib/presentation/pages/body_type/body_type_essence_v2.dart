        ...
        slivers: [
          ...
          SliverToBoxAlternate(child: Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Your Essence', style: TextStyle(fontSize: 12, color: Color(0xFF533afd), fontWeight: FontWeight.w500, letterSpacing: 1.5)),
              const SizedBox(height: 4),
              Text('Your Seasonal Essence: Balanced', style: TextStyle(
          ...
          SliverToBoxAlternate(child: Padding(
            ...
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('"Harmony in Flux"', style: TextStyle(fontFamily: ShunShiTypography.serifFamily, fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
          ...
          SliverToBoxAlternate(child: Padding(
            ...
            child: Text('Your Natural Rhythm', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary)),
          )),
        ],
      ),
    );
