  ...
  group('GentleButton widget', () {
    testWidgets('renders with label text', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: GentleButton(text: '确认', onPressed: () {}),
          ),
        ),
      );
    ...
    testWidgets('calls onTap when pressed', (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: GentleButton(text: '立春养生', onPressed: () => tapped = true),
          ),
        ),
      );
    ...
    testWidgets('shows loading indicator when isLoading is true', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: GentleButton(text: '加载中', onPressed: () {}, isLoading: true),
          ),
        ),
      );
