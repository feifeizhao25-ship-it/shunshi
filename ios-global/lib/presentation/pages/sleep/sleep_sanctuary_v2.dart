          ...
          children: [
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                Text('Sleep Sanctuary', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white70)),
                const Spacer(),
            ...
            Text('Nightfall Stillness', style: TextStyle(
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('Sleep Stories', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white70)),
