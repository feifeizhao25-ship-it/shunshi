      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Title
            Text('Breathing into Change', style: TextStyle(
              fontFamily: ShunShiTypography.serifFamily,
              fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white,
            )),
            const SizedBox(height: 4),
            Text('10 Min · Grounding', style: TextStyle(fontSize: 14, color: Colors.white54)),
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('Atmosphere Layer', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Colors.white70)),
