      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _genderOption('男', Icons.male, '👨'),
              ),
              const SizedBox(width: 16),
              Expanded(
                child: _genderOption('女', Icons.female, '👩'),
              ),
            ],
          ),
        ],
    ...
    return _stepWrapper(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          Text('${_currentYear - _birthYear}岁',
