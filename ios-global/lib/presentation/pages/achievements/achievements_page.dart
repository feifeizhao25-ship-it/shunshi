                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GridView.count(
                      ...
                      crossAxisSpacing: 12,
                      children: const [
                        _BadgeCard(icon: '🌅', label: 'Early Riser', unlocked: true),
                        _BadgeCard(icon: '🧘', label: 'Practice Starter', unlocked: true),
                        _BadgeCard(icon: '🍵', label: 'Food Therapy Expert', unlocked: true),
                        _BadgeCard(icon: '🏔️', label: '100-Day Commitment', unlocked: false),
                        _BadgeCard(icon: '🌿', label: 'Solar Term Master', unlocked: false),
                        _BadgeCard(icon: '⭐', label: 'Community Star', unlocked: false),
                      ],
                    ),
