        ...
        slivers: [
          ...
          SliverToBoxAlternate(child: Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Your Growth Journey', style: TextStyle(
          ...
          SliverToBoxAlternate(child: Padding(
            ...
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('Spring Equinox Alignment', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                const SizedBox(height: 8),
                ...
                const SizedBox(height: 4),
                Text('85% TOWARDS HARVEST', style: TextStyle(fontSize: 11, color: Color(0xFFE4C285))),
              ]),
            ),
          )),
