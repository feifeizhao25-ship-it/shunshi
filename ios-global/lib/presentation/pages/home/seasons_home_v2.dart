              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text("Today's Rhythm", style: TextStyle(
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('Seasonal Wisdom', style: TextStyle(fontSize: 12, color: Colors.white70, fontWeight: FontWeight.w500)),
                          ...
                          Row(children: [
                            Text('Explore Principle', style: TextStyle(fontSize: 13, color: Color(0xFFE4C285), fontWeight: FontWeight.w500)),
                        ...
                        child: Container(
                          ...
                          child: Row(children: [
                            ...
                            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Text('Gentle Reminder', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFF533afd))),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          ...
                          const SizedBox(width: 12),
                          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text('SEASONS Companion', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary)),
                            Text('"$_companionTip"',
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      padding: const EdgeInsets.fromLTRB(24, 20, 24, 0),
                      child: Text('Quick Rituals', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary)),
                    ),
                  ),
                  SliverToBoxAdapter(
                    child: Padding(
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      padding: const EdgeInsets.fromLTRB(24, 20, 24, 0),
                      child: Row(children: [
                        Text('Seasonal Library', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: ShunShiColors.textPrimary)),
                        const Spacer(),
                        Text('See All', style: TextStyle(fontSize: 13, color: const Color(0xFF533afd), fontWeight: FontWeight.w500)),
                      ]),
                    ),
                  ),
                  SliverToBoxAdapter(
