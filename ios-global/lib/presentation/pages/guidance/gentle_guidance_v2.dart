        ...
        slivers: [
          ...
          SliverToBoxAlternate(child: Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Daily Whisper', style: TextStyle(fontSize: 12, color: Color(0xFF533afd), fontWeight: FontWeight.w500, letterSpacing: 1.5)),
              const SizedBox(height: 4),
              Text('Gentle Guidance', style: TextStyle(fontFamily: ShunShiTypography.serifFamily, fontSize: 28, fontWeight: FontWeight.bold, color: ShunShiColors.textPrimary)),
              const SizedBox(height: 4),
            ...
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  ...
                  Text('Vata-Pitta Balance', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.white)),
                ]),
                const SizedBox(height: 4),
                Text('Body Type Insight', style: TextStyle(fontSize: 11, color: Colors.white54)),
                ...
                const SizedBox(height: 10),
                Text('Personalized for your cycle', style: TextStyle(fontSize: 11, color: Color(0xFFE4C285))),
                const SizedBox(height: 8),
                Text('Deepen Insight', style: TextStyle(fontSize: 13, color: Color(0xFFE4C285), fontWeight: FontWeight.w500)),
              ]),
            ),
          )),
