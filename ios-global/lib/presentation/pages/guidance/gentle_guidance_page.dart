  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Gentle Guidance', style: TextStyle(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Daily Whisper', style: TextStyle(
            ...
            Container(
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Text('Personalized for your cycle', style: TextStyle(
