...
class ApiService {
  ...
  // ===================
  // SEASONS International API
  // ===================

  /// Get full dashboard: greeting, insight, ritual, suggestions
  Future<Map<String, dynamic>> getIntlDashboard({
  ...
  /// Get daily insight
  Future<Map<String, dynamic>> getIntlDailyInsight({
    String hemisphere = 'north',
    String? mood,
  }) async {
    final response = await _dio.get(
  ...
  /// Get 3 gentle suggestions
  Future<Map<String, dynamic>> getIntlRecommendations({
    String hemisphere = 'north',
    String? timeOfDay,
  }) async {
    final response = await _dio.get(
  ...
  /// Get current season
  Future<Map<String, dynamic>> getIntlCurrentSeason({
    String hemisphere = 'north',
  }) async {
    final response = await _dio.get(
  ...
  /// Get season ritual
  Future<Map<String, dynamic>> getIntlSeasonRitual(
    String season, {
  ...
  /// Log a reflection
  Future<Map<String, dynamic>> postIntlReflection({
    required String mood,
    required int energy,
    double? sleepHours,
    String? sleepQuality,
  ...
  Future<Map<String, dynamic>> getIntlReflectionPrompt({
  ...
  /// Get season-aware greeting
  Future<Map<String, dynamic>> getIntlGreeting({
    String hemisphere = 'north',
    String? timeOfDay,
  }) async {
    final response = await _dio.get(
